...
- Choose a city manually instead of granting current-location access
...
- Create weekly and monthly daylight summaries
...
- A selected city and last resolved coordinates
- Cached Apple Weather forecast context
- An optional self-reported skin response profile
- Reminder preferences and notification status
- Appearance, onboarding, and other app preferences
- Verified Pro access status needed to unlock purchased features
- Versioned snapshots shared between the App and its WidgetKit extension

This information is not sent to a developer-operated server. Local data may be included in device backups according to your Apple backup settings and Apple's policies.
...
If you contact us by email, we may receive your email address, message, device information, screenshots, or other information you choose to provide. We use this information only to answer your request, investigate technical issues, and improve support.

Please do not include Apple Health records, precise location information, or other sensitive personal information unless it is necessary for your support request. Support communications may be retained for as long as reasonably necessary to resolve the request, maintain support records, or comply with applicable law.
...
- Build advertising profiles from your daylight, location, or profile information

## 10. Sharing and Service Providers

We do not share Apple Health data, manual sessions, skin response profiles, or cached forecast history with third parties. Information may be processed by Apple when you:
...
We may update this Privacy Policy when the App's features, data practices, or legal requirements change. The updated policy will be published on this page with a revised effective date. Material changes will be communicated when required by applicable law.

## 16. Contact Us

For privacy questions, support requests, or requests concerning information sent through customer support, contact:

Email: [jxiaoai@icloud.com](mailto:jxiaoai@icloud.com)
